Slash Commands for Azure DevOps Wiki Ops
...
- Command:
  - `az devops wiki page show --wiki DevSecOps.wiki --path "<wiki_path>" --query page.remoteUrl -o tsv | pbcopy`
- Example:
  - `/copy-wiki-url /Security Best Practices/Cloud Security/Azure: Patterns & Practices`
